...
class OrderTest {
    ...
    void remove() {
        ...
        test.remove(new OrderLine(1,new Chicken(),new Chicken().price()));
        assertEquals((new OrderLine(1,new Fish(),new Fish().price())).toString(),test.getOrderLines().get(1).toString());
    }
